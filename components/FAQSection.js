...
const FAQSection = () => {
  ...
  return (
    <section id="faqs" className="bg-white mt-20 mb-20 FAQ_section">
      ...
      {/* FAQ Item 0 */}
      <div className={`faq-item bg-gray-200 rounded-lg p-4 md:pb-1 md:pt-4 mb-6 max-w-md mx-auto cursor-pointer ${isOpen[0] ? 'open' : ''}`} onClick={() => toggleFAQ(0)}>
        ...
        <p id="para1" className={`font-normal text-base leading-6 text-gray-700 mt-4 w-11/12 ${isOpen[0] ? 'fade-in' : 'fade-out'}`}>
      ...
      <div className={`faq-item bg-gray-200 rounded-lg p-4 md:pb-1 md:pt-4 md:p-6 mb-6 max-w-md mx-auto cursor-pointer ${isOpen[1] ? 'open' : ''}`} onClick={() => toggleFAQ(1)}>
        ...
        <p id="para2" className={`font-normal text-base leading-6 text-gray-700 mt-4 w-11/12 ${isOpen[1] ? 'fade-in' : 'fade-out'}`}>
      ...
      <div className={`faq-item bg-gray-200 rounded-lg p-4 md:pb-1 md:pt-4 md:p-6 mb-6 max-w-md mx-auto cursor-pointer ${isOpen[2] ? 'open' : ''}`} onClick={() => toggleFAQ(2)}>
        ...
        <p id="para3" className={`font-normal  text-base leading-6 text-gray-700 mt-4 w-11/12 ${isOpen[2] ? 'fade-in' : 'fade-out'}`}>
      ...
      <div className={`faq-item bg-gray-200 rounded-lg p-4 md:pb-1 md:pt-4 md:p-6 mb-6 max-w-md mx-auto cursor-pointer ${isOpen[3] ? 'open' : ''}`} onClick={() => toggleFAQ(3)}>
        ...
        <p id="para4" className={`font-normal text-base leading-6 text-gray-700 mt-4 w-11/12 ${isOpen[3] ? 'fade-in' : 'fade-out'}`}>
      ...
      <div className={`faq-item bg-gray-200 rounded-lg p-4 md:pb-1 md:pt-4 md:p-6 mb-6 max-w-md mx-auto cursor-pointer ${isOpen[4] ? 'open' : ''}`} onClick={() => toggleFAQ(4)}>
        ...
        <p id="para5" className={`font-normal text-base leading-6 text-gray-700 mt-4 w-11/12 ${isOpen[4] ? 'fade-in' : 'fade-out'}`}>
