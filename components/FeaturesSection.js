          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="p-7 max-w-sm mx-auto bg-gray-50 rounded-lg shadow-md flex flex-col items-center">
              <div className="flex-shrink-0">
                              ...
                              src="https://raw.githubusercontent.com/joshiebudd/notionwidgets/main/external-transfer-arrows-kmg-design-glyph-kmg-design.webp" 
                              width={800}  // Set the width of the image (you can adjust as needed)
                              height={566} // Set the height of the image (adjust for the aspect ratio of your image)
                              alt="Business Automation Icon" />
              </div>
            ...
            <div className="p-7 max-w-sm mx-auto bg-gray-50 rounded-lg shadow-md flex flex-col items-center">
              <div className="flex-shrink-0">
                              <Image style={{ display: 'block' }} className="w-10 h-10" 
                              src="https://raw.githubusercontent.com/joshiebudd/notionwidgets/main/opened-folder.webp" 
                              width={800}  // Set the width of the image (you can adjust as needed)
                              height={566} // Set the height of the image (adjust for the aspect ratio of your image)
                              alt="Business Automation Icon" />
              </div>
