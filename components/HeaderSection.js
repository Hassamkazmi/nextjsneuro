                ...
                <nav className="px-8 py-5 lg:px-6">
                    <div className="mx-auto flex max-w-screen-xl flex-wrap items-center justify-between">
                        ...
                        <div className={`lg:hidden ${isMobileMenuOpen ? 'block' : 'hidden'}`}>
                            <div className="flex flex-col items-center space-y-4 mt-4 add-class-head lg:bg-opacity-30 lg:backdrop-blur-lg" style={{ backdropFilter: 'blur(10px)' }}>
                                <a onClick={() => scrollToMiddle('features')} className="text-black cursor-pointer hover:underline">Features</a>
                                <a onClick={() => scrollToMiddle('pricing')} className="text-black cursor-pointer hover:underline">Pricing</a>
                                <a onClick={() => scrollToMiddle('faqs')} className="text-black cursor-pointer hover:underline">FAQs</a>
                        ...
                        <div className="hidden lg:flex items-center space-x-4">
                            <a onClick={() => scrollToMiddle('features')} className="text-lg font-thin text-black hover:text-gray-600 cursor-pointer hover:underline">Features</a>
                            <a onClick={() => scrollToMiddle('pricing')} className="text-lg font-thin text-black hover:text-gray-600 cursor-pointer hover:underline">Pricing</a>
                            <a onClick={() => scrollToMiddle('faqs')} className="text-lg font-thin text-black hover:text-gray-600 cursor-pointer hover:underline">FAQs</a>
                        </div>
                        {/* Buy Now Button for Desktop */}
                        <a href="#pricing" onClick={handleButtonClick} className="hidden lg:inline-block rounded-lg bg-black px-4 py-2 text-lg font-bold text-white hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 lg:px-8 lg:py-4">Buy Now</a>
                    </div>
                </nav>
            </div>
        </header>
